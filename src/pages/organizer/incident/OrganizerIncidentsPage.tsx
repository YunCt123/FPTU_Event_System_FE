...
import { AlertTriangle, Search, Eye, Edit2 } from "lucide-react";
import IncidentDetailModal from "../../../components/organizer/incident/IncidentDetailModal";
import EditIncidentModal from "../../../components/organizer/incident/EditIncidentModal";

const OrganizerIncidentsPage: React.FC = () => {
  ...
  const fetchIncidents = async () => {
    try {
      ...
      // For organizer, backend already filters to only their events' incidents
  ...
  const handleEdit = (incident: IssueResponse) => {
    setSelectedIncident(incident);
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Quản lý Sự cố</h1>
        <p className="text-gray-600">
          Xem và quản lý các sự cố của sự kiện do bạn tổ chức
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div className="bg-linear-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-transform">
          <div className="flex items-center justify-between">
            ...
            <div className="w-16 h-16 bg-opacity-20 rounded-2xl flex items-center justify-center backdrop-blur-sm bg-blue-50">
              <AlertTriangle className="text-blue-500" size={32} />
            </div>
          </div>
        </div>

        <div className="bg-linear-to-br from-yellow-500 to-yellow-600 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-transform">
          <div className="flex items-center justify-between">
            <div>
            ...
            <div className="w-16 h-16  bg-opacity-20 rounded-2xl flex items-center justify-center backdrop-blur-sm bg-yellow-50">
        ...
        <div className="bg-linear-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-transform">
          <div className="flex items-center justify-between">
            ...
            <div className="w-16 h-16  bg-opacity-20 rounded-2xl flex items-center justify-center backdrop-blur-sm  bg-green-50">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="mt-4 text-sm text-gray-600">
          Tìm thấy{" "}
          <span className="font-semibold">{filteredIncidents.length}</span> sự
          cố
        </div>
      </div>
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex flex-col gap-2 ml-4">
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-linear-to-br from-blue-400 to-blue-500 hover:bg-blue-700 text-white rounded-lg transition-colors text-sm"
                  >
                    <Eye size={16} />
                    Xem
                  </button>
...
export default OrganizerIncidentsPage;
